...
def predictImage(request):
    ...
    if crop=='Potato':
        ...
        class_names=['Cherry_(including_sour)___Powdery_mildew','Cherry_(including_sour)___healthy']
    elif crop=='Bell-Pepper':
        with open('./plant_leaf_disease_detector/models/labelB.json','r') as f:
            labelInfo=f.read()
        model=load_model('./plant_leaf_disease_detector/models/bellpeper.h5')
